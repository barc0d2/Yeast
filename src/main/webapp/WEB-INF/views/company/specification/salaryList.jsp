          ...
          <c:forEach var="employee" items="${employees}">
            <tr>
              <td>
                ...
                <button class="procure" data-update="${formattedDate}" onclick="location.href='/company/specification/salaryDetail?userNo=${employee.userNo}'">
                </button>
              </td>
      ...
      <div id="pagination">
        <ul>
          <c:choose>
            ...
            <c:otherwise>
              <li class="pre-page"><a class="page-link" href="/company/specification/salaryList?cpage=${pi.currentPage - 1}"><svg width="29" height="26" style="transform: translateX(-8px)" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
            <c:choose>
              ...
              <c:otherwise>
                <li class="page"><div class="unSelectPage"><a class="page-link" href="/company/specification/salaryList?cpage=${p}">${p}</a></div></li>
              </c:otherwise>
            </c:choose>
          </c:forEach>
          ...
          <c:choose>
            ...
            <c:otherwise>
              <li class="next-page"><a class="page-link" href="/company/specification/salaryList?cpage=${pi.currentPage + 1}"><svg width="29" height="26" style="transform: translateX(-6px)" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
