...
<main class="frame">
    <section class="div">
            ...
            <form class="filter" action="#" method="get">
                <div class="overlap-group">
                    ...
                    <div class="enroll-filter">
                            <div class="order-status">입사일 <svg width="13" height="8" viewBox="0 0 13 8" fill="none"
                                                              xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="department-filter">
                        <div class="order-type">부서명 <svg width="13" height="8" viewBox="0 0 13 8" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.34197 0.584961L6.7892 5.16996L11.2364 0.584961L12.6089 1.99996L6.7892 7.99996L0.969482 1.99996L2.34197 0.584961Z"
                                  fill="black"/></svg> </div>
                    </div>
                    <div class="position-filter">
                        <div class="filter-by">직무 <svg width="13" height="8" viewBox="0 0 13 8" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.34197 0.584961L6.7892 5.16996L11.2364 0.584961L12.6089 1.99996L6.7892 7.99996L0.969482 1.99996L2.34197 0.584961Z"
                                  fill="black"/></svg></div>
                    </div>
        ...
        <nav class="page-bar" aria-label="Pagination">
            <button class="next-page" aria-label="Next page"><svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="pre-page" aria-label="Previous page"><svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
