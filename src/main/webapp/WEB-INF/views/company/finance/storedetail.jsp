        ...
        <div id="pagination">
            <ul>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="pre-page">
                            <a class="page-link" href="/company/finance/detail?cpage=${pi.currentPage - 1}&businessNo=${param.businessNo}&period=${param.period}">
                        ...
                        <c:otherwise>
                            <li class="page">
                                <div class="unSelectPage">
                                    <a class="page-link" href="/company/finance/detail?cpage=${p}&businessNo=${param.businessNo}&period=${param.period}">${p}</a>
                                </div>
                            </li>
                        </c:otherwise>
                    </c:choose>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            function updateURL() {
                ...
                let url = "/company/finance/detail?businessNo="+businessNo+"&period="+period;
