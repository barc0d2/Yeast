...
<html>
  <head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="/css/company/product/list/globals.css" />
    <link rel="stylesheet" href="/css/company/product/list/style.css" />
    <link rel="stylesheet" href="/css/company/product/list/styleguide.css" />
  </head>
  <body>
    <div class="screen">
      <div class="frame">
        <div class="container">
          ...
          <div class="list">
            <div class="div">
              ...
              <div class="div-2">
                <div class="div-3">
                  <div class="text-wrapper-4">블랙 올리브 베이글</div>
                  <div class="div-4">
                    <div class="text-wrapper-5">종류 : 베이글</div>
                    <div class="text-wrapper-6">출시일 : 2023/03/14</div>
                    <div class="text-wrapper-6">가격 : 3,600 ￦</div>
                    <div class="text-wrapper-6"> 총 내용량당 칼로리(kcal): 345</div>
                    <p class="text-wrapper-6">알레리기 정보 : 밀, 우유, 대두</p>
                  </div>
                </div>
                <p class="text-wrapper-6">블랙올리브 고소한 롤치즈가 들어간 짭조름하게 맛있는 베이글</p>
              </div>
            </div>
            <div class="div">
              <img class="image" src="img/image-47-3.png" />
              <div class="div-2">
                <div class="div-3">
                  <div class="text-wrapper-4">블랙 올리브 베이글</div>
                  <div class="div-4">
            ...
            <div class="div">
              <img class="image" src="img/image-47.png" />
              <div class="div-2">
                <div class="div-3">
                  <div class="text-wrapper-4">블랙 올리브 베이글</div>
                  <div class="div-4">
            ...
            <div class="div">
              <img class="image" src="img/image-47-2.png" />
              <div class="div-2">
                <div class="div-3">
                  <div class="text-wrapper-4">블랙 올리브 베이글</div>
                  <div class="div-4">
