...
<html>
  <head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="/css/order/orderProcessComplete/style.css" />
    <link rel="stylesheet" href="/css/order/orderProcessComplete/global.css" />
    <link rel="stylesheet" href="/css/order/orderProcessComplete/styleguide.css" />
  </head>
  <body>
    <div class="screen">
      <div class="content">
        <div class="ordering-complete"><div class="text-wrapper">발주처리완료</div></div>
        <div class="column">
          <div class="basic-info">기본 정보</div>
          <div class="list">
            <div class="div">
              <p class="line"><span class="span">*</span> <span class="text-wrapper-2">발주자</span></p>
              <div class="name"><div class="text-wrapper-3">호원준</div></div>
            </div>
            <div class="div">
              <div class="line-2">*납입예정일</div>
              <div class="date">
                <div class="text-wrapper-3">2025-03-19</div>
                <img class="image" src="../../../../resources/uploadfile/image/orderManagement/calendar.png" />
              </div>
            </div>
            <div class="manager">
              <div class="line-2">*담당자</div>
              <div class="name-wrapper"><div class="text-wrapper-3">호원준</div></div>
            </div>
            <div class="btn">
        ...
        <div class="frame">
          <div class="body">
            ...
            <div class="table">
              <div class="label">
                <div class="text-wrapper-4">회사명</div>
                <div class="text-wrapper-5">빵 종류</div>
                <div class="text-wrapper-6">빵이름</div>
                <div class="amount">갯수</div>
                <div class="text-wrapper-4">구매가격</div>
                <div class="delete-btn">삭제</div>
              </div>
              <div class="row">
                <div class="company">아스트</div>
                <div class="text-wrapper-5">소금빵</div>
                <div class="text-wrapper-6">사과소금빵</div>
              ...
              <div class="row">
                ...
                <div class="text-wrapper-5">단팥빵</div>
                <div class="text-wrapper-6">앙금단팥빵</div>
              ...
              <div class="row">
                <div class="company">이스트</div>
                <div class="text-wrapper-5">오금빵</div>
                <div class="text-wrapper-6">오금지린빵</div>
                <div class="amount">50</div>
                <div class="price-2">50,000</div>
                <div class="delete">
                  <div class="delete-btn-2">삭제</div>
              ...
              <div class="row">
                <div class="company">이스트</div>
                <div class="text-wrapper-5">호두빵</div>
                <div class="text-wrapper-6">호두과자빵</div>
                <div class="amount">50</div>
                <div class="price-2">50,000</div>
                <div class="delete">
                  <div class="delete-btn-2">삭제</div>
              ...
              <div class="row">
                <div class="company">이스트</div>
                <div class="text-wrapper-5">슈크림빵</div>
                <div class="text-wrapper-4">슈바슈크림빵</div>
                <div class="amount">50</div>
                <div class="price-2">50,000</div>
                <div class="delete">
                  <div class="delete-btn-2">삭제</div>
              ...
              <div class="row">
                <div class="company">이스트</div>
                <div class="text-wrapper-5">초코빵</div>
                <div class="text-wrapper-6">소라초코빵</div>
                <div class="amount-2">50</div>
                <div class="price">50,000</div>
                <div class="delete">
                  <div class="delete-btn-2">삭제</div>
