...
<body>
<form class="store" action="/branch/store/updateThings" method="post" enctype="multipart/form-data">
    <div class="form">
        ...
        <section class="list">
            <div class="div">
                ...
                <div class="input">
                    <input type="text" id="branch-number" class="text-wrapper-2" name="businessNo"
            ...
            <div class="div">
                ...
                <div class="div-wrapper">
                    <input type="text" id="branch-name" class="text-wrapper-2" name="businessName"
