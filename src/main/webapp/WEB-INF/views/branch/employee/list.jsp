      ...
      <section class="frame">
            ...
            <div class="overlap-group">
              ...
              <button type="reset" class="reset-filter">
                <div class="frame-wrapper">
                  <div class="div">
                    <img class="under-arrow" src="img/under-arrow.png" alt="Reset arrow" />
                    <span class="text-wrapper">Reset Filter</span>
                  </div>
                </div>
              </button>
              <div class="enroll-filter">
                <img class="line" src="img/line-3.svg" alt="Vertical line" />
                <img class="img" src="img/under-arrow-2.png" alt="Down arrow" />
                <label for="enroll-date" class="order-status">입사일</label>
                <select id="enroll-date" name="enroll-date" class="visually-hidden">
                  <option value="">Select enrollment date</option>
                </select>
              </div>
              <div class="department-filter">
                <img class="line-2" src="img/line-2.svg" alt="Vertical line" />
                ...
                <select id="department" name="department" class="visually-hidden">
                  <option value="">Select department</option>
                </select>
              </div>
              <div class="position-filter">
                <img class="under-arrow-2" src="img/image.png" alt="Down arrow" />
                <img class="line-3" src="img/line.svg" alt="Vertical line" />
                <label for="position" class="filter-by">직무</label>
                <select id="position" name="position" class="visually-hidden">
        ...
        <nav class="page-bar" aria-label="Pagination">
          <button class="next-page" aria-label="Next page">
            <img class="icon" src="img/image.svg" alt="Next page icon" />
          </button>
          <button class="pre-page" aria-label="Previous page">
            <img class="icon" src="img/icon.svg" alt="Previous page icon" />
          </button>
          <button class="page"><span class="text-wrapper-4">1</span></button>
          <button class="page-2"><span class="text-wrapper-4">2</span></button>
          <button class="select-page" aria-current="page"><span class="text-wrapper-5">3</span></button>
