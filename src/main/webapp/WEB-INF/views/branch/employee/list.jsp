        ...
        <ul>
            ...
            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page"><div class="unSelectPage"><a class="page-link" href="/branch/employee/list?currentPage=${p}">${p}</a></div></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li class="next-page">
                        <a class="page-link" href="/branch/employee/list?currentPage=${pi.currentPage + 1}"><svg width="29" height="26" style="transform: translateX(-6px)" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
